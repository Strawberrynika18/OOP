...
import OOP.task5.InfantryClass.*;
import OOP.task5.MagClass.*;
import OOP.task5.ShooterClass.*;
import OOP.task5.Crossbowman;
import OOP.task5.Snipper;
import OOP.task5.Outlaw;
import OOP.task5.Spearman;
            ...
            for (int i = 1; i < GANG_SIZE + 1; i++) {
                switch(new Random().nextInt(4)){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        whiteSide.add(new Monah(BaseHero.generateName(), 10, i));
                        break;
                    default:
