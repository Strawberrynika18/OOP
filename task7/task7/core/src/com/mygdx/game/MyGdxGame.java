...
import com.mygdx.task7.programs.BaseHero;
import com.mygdx.task7.programs.ClassPeasant;
import com.mygdx.task7.programs.InfantryClass.Outlaw;
import com.mygdx.task7.programs.InfantryClass.Spearman;
import com.mygdx.task7.programs.MagClass.Magician;
import com.mygdx.task7.programs.MagClass.Monk;
import com.mygdx.task7.programs.ShooterClass.Crossbowman;
import com.mygdx.task7.programs.ShooterClass.Snipper;
import java.util.ArrayList;
import java.util.Random;
import static com.mygdx.programs.MainProgramm.step;
public class MyGdxGame extends ApplicationAdapter {
	...
	public void create() {
		...
		monk = new Texture("units/Monah.png");
	...
	public static void Init() {
		...
		for (int i = GANG_SIZE; i > 0; i--) {
			switch(new Random().nextInt(4)){
				...
				case 2:
					whiteSide.add(new Monah(BaseHero.generateName(), 1, i));break;
				default:
